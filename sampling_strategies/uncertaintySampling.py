...
from active_learning.sampling_strategies.BaseSamplingStrategy import BaseSamplingStrategy
import numpy as np
...
class UncertaintySampler(BaseSamplingStrategy):
    ...
    def what_to_label_next(self, NR_QUERIES_PER_ITERATION: int, learner: Learner, data_storage: DataStorage) -> IndiceMask:
